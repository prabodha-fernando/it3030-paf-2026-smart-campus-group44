...
public interface BookingRepository extends JpaRepository<Booking, Long> {
       ...
       @Query(value = "select b from Booking b join fetch b.requestedBy where b.date between :startDate and :endDate", countQuery = "select count(b) from Booking b where b.date between :startDate and :endDate")
       Page<Booking> findAllByDateBetween(@Param("startDate") LocalDate startDate, @Param("endDate") LocalDate endDate,
                     Pageable pageable);

       @Query(value = "select b from Booking b join fetch b.requestedBy where b.date between :startDate and :endDate and b.status = :status", countQuery = "select count(b) from Booking b where b.date between :startDate and :endDate and b.status = :status")
       Page<Booking> findAllByDateBetweenAndStatus(@Param("startDate") LocalDate startDate,
                     @Param("endDate") LocalDate endDate,
                     @Param("status") BookingStatus status, Pageable pageable);

       // Methods for regular users with date range filtering
       @Query(value = "select b from Booking b join fetch b.requestedBy where b.requestedBy = :user and b.date between :startDate and :endDate", countQuery = "select count(b) from Booking b where b.requestedBy = :user and b.date between :startDate and :endDate")
       Page<Booking> findAllByRequestedByAndDateBetween(@Param("user") User requestedBy,
                     @Param("startDate") LocalDate startDate, @Param("endDate") LocalDate endDate, Pageable pageable);

       @Query(value = "select b from Booking b join fetch b.requestedBy where b.requestedBy = :user and b.date between :startDate and :endDate and b.status = :status", countQuery = "select count(b) from Booking b where b.requestedBy = :user and b.date between :startDate and :endDate and b.status = :status")
       Page<Booking> findAllByRequestedByAndDateBetweenAndStatus(@Param("user") User requestedBy,
